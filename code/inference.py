...
def inference(model, tokenized_sent, device):
    ...
    """
    dataloader = DataLoader(tokenized_sent, batch_size=16,
...
def main(args):
    ...
    if args.ensemble:
        ...
        # predict answer
            ...
            custom_pred_answer, custom_output_prob = inference(
                model, custom_Re_test_dataset, device)  # model에서 class 추론
    ...
    #### 필수!! ##############################################
    print(classification_report(custom_test_label,
          custom_pred_answer))
    print('---- Finish! ----')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ensemble_option', type=str,
                        default='mean', help='mean, hard_voting')
